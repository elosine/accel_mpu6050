...
/*
  ...
  //Accelerometer angle Y - Forward/Backward
  Serial.print( F("AcY:") );
  Serial.print(accel_angle_y, 2);
  Serial.print(";");

  //Gyroscope angle X - Left/Right
  Serial.print(F("GyX:"));
  Serial.print(angle_x, 2);
  Serial.print(";");

  //Gyroscope angle Y - Forward/Backward
  Serial.print(F("GyY:"));
  Serial.print(angle_y, 2);
  Serial.print(";");

  //Gyroscope angle Z - Twist
  Serial.print(F("GyZ:"));
...
if(ct%1 == 0){
  ...
  Serial.print( F("AcXv:") );
  Serial.print(abs(deltaAcX), 2);
  Serial.print(";");

  //Accelerometer angle Y - Forward/Backward
  deltaAcY = accel_angle_y - pAcY; //find out amount of change per frame
  Serial.print( F("AcYv:") );
  Serial.print(abs(deltaAcY), 2);
  Serial.print(";");

  pAcX = accel_angle_x; //update the previous value
  pAcY = accel_angle_y; //update the previous value
}
